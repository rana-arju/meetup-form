...
export default function ReunionPage() {
  return (
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-3 sm:px-4 py-12 sm:py-20">
        <div className="text-center max-w-4xl mx-auto w-full">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#CBD5E1] mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-2">
            ২०२३ সালে ডিপ্লোমা শেষ করার পর জীবন সবাইকে ব্যস্ত করে ফেলেছে। তবুও কিছু সম্পর্ক, কিছু স্মৃতি, কিছু
      ...
      <section id="details" className="relative py-12 sm:py-16 md:py-20 px-3 sm:px-4">
            ...
            {[
              {
                ...
                description: 'অনেকদিন পর সবার সাথে সামনাসামনি দেখা, গল্প আর আড্ডা—এটাই হবে এই আয়োজনের সবচেয়ে বড় আনন্দ।',
                icon: Users,
              },
              {
                title: 'স্মৃতিগুলো আবার ছুঁয়ে দেখা',
                description: 'ক্লাস, প্র্যাকটিক্যাল, পরীক্ষা, ট্যুর, হাসি-মজা—সব পুরোনো মুহূর্তগুলো আবার মনে করার একটা সুন্দর সুযোগ।',
                icon: Heart,
              },
              {
                title: 'নতুন করে সংযোগ তৈরি',
                description: 'জীবন সবাইকে আলাদা পথে নিয়ে গেছে, কিন্তু এই আয়োজন আমাদের আবার এক সুতোয় গেঁথে দিতে পারে।',
                icon: Mail,
              },
              {
                title: 'একটা স্মরণীয় দিন',
                description: 'ব্যস্ত জীবনের ভিড়ে এমন একটা দিন দরকার, যেটা বহু বছর পরও মনে থাকবে।',
                icon: Clock,
              },
            ].map((item, index) => {
              ...
              return (
                <div key={index} className="relative group">
                  ...
                  <div className="relative p-5 sm:p-6 md:p-8 rounded-2xl bg-[#1E293B]/50 border border-[#334155] hover:border-[#F59E0B]/50 transition-colors">
                    ...
                    <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#FFF7ED] mb-2 sm:mb-3">{item.title}</h3>
                    <p className="text-sm sm:text-base text-[#CBD5E1]">{item.description}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 text-sm sm:text-base md:text-lg text-[#CBD5E1] leading-relaxed mb-8 sm:mb-10 md:mb-12 px-2">
              <p>জীবনের ব্যস্ততায় সবাই দূরে সরে গেলেও, কিছু মানুষ আর কিছু স্মৃতি সবসময় আপন থেকে যায়।</p>
